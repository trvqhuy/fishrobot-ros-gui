...
class ImuListener(Node):
    ...
    def listener_callback_pose(self, msg):
        ...
        try:
            ...
            self.euler_angles['yaw'].append(yaw)
            self.euler_angles['pitch'].append(pitch)
            self.euler_angles['roll'].append(roll)
        except Exception as e:
            print(f"[Euler conversion error] quat={quat}, error={e}")
            self.euler_angles['yaw'].append(0.0)
            self.euler_angles['pitch'].append(0.0)
            self.euler_angles['roll'].append(0.0)
